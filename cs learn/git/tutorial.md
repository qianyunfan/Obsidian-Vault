...
# START
1. cd to a dictionary you want.
2. cmd input  `git init` , it will make this dictionary become a **repository**, which can record and control all changes by generate **.git** folder.
3. 